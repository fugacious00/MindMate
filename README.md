...
- 🎯 **Habit Building** - Build positive habits with visual streaks
...
| App | Website |
|-----|---------|
| Mood tracking & analytics | Landing page |
| Journal with search | Sign up/Login |
| Sleep monitoring | Dashboard |
| Habit builder | User profile |
